...
export const metadata = {
  title: 'Legal Notice — Jobvero',
  description: 'Legal information about MELNZ LLC and Jobvero',
};

export default async function LegalPage() {
  const filePath = path.join(process.cwd(), 'src/content/legal/legal-mentions.md');
